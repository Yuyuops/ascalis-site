          ...
          <Reveal reduceMotion={reduceMotion}>
            <div className="max-w-xl">
              ...
              <p className="mt-4 text-base leading-8 text-white/60">
                Calculateurs, check-lists, matrices et outils d’analyse accessibles directement, sans login. Calibrés pour les responsables qualité, méthodes, performance et lean qui ont besoin d’un outil opérationnel, pas d’une formation.
              </p>
              <p className="mt-4 text-base leading-8 text-white/60">
                L’espace pro va plus loin : diagnostic terrain, plans de contrôle, 8D, DMAIC complet avec moteur statistique. Un cockpit pensé pour le pilotage quotidien.
              </p>
